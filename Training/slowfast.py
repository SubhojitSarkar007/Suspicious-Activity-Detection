...
def SlowFast_body(inputs, layers, block, num_classes, dropout=0.5):
    ...
    #x = Flatten()
    #x = Dense(num_classes*50, activation = "relu")(x)
    x = Dropout(dropout)(x)
...
def Fast_body(x, layers, block):
    ...
    lateral_p1 = Dropout(0.5)(lateral_p1)
    ...
    lateral_res2 = Dropout(0.5)(lateral_res2)
    ...
    lateral_res3 = Dropout(0.5)(lateral_res3)
    ...
    lateral_res4 = Dropout(0.5)(lateral_res4)
    lateral.append(lateral_res4)
    '''
    x, fast_inplanes = make_layer_fast(x, block, 64, layers[2], stride=2, head_conv=3, fast_inplanes=fast_inplanes)
